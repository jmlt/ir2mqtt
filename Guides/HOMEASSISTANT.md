...
This guide shows how to manually create MQTT and binary sensors in Home Assistant.
...
Add the following YAML code snippet to create sensors for iR2mqtt telemetry data.
